...
--
-- Servidor: localhost
-- Tiempo de generación: 06-12-2019 a las 22:59:25
...
(4, 'Prueba 1', 5, 0, 'add', 'admin', '2019-12-02 17:12:17');
...
(2, 2, 38, 0, 'edit', 'admin', '2019-12-06 09:12:18'),
(4, 1, 2, 0, 'add', 'admin', '2019-12-03 11:12:11'),
(5, 2, 45, 0, 'add', 'admin', '2019-12-06 09:12:43'),
(6, 4, 3, 0, 'add', 'admin', '2019-12-06 09:12:47'),
(7, 5, 1, 0, 'add', 'admin', '2019-12-06 09:12:53');
...
(1, 'SISTEMA WEB PARA LA GESTIÓN DE PROYECTOS DE INVESTIGACIÓN APLICADA Y FORMATIVA - UNIHORIZONTE.', 'FI210035', 'ACTO123', 4, 4, 1, 4, 7, 1, 3, 9999, 'Se trata de un sistema web para gestionar los productos generados por concepto de investigación aplicada o investigación formativa de los docentes, investigadores, estudiantes, auxiliares de investigación, semilleristas, funcionarios administrativos o usuarios externos de la universidad UniHorizonte, procurando mantener los indicadores y ponderaciones de manera que sean compatibles con los criterios de medición estipulados por Colciencias.', '2019-11-29', '0000-00-00', '1_archivo_informe_final.txt', 2664, 1, 0, 'edit', 'admin', '2019-12-02 17:12:17'),
(2, 'Encuentros de Proyectos Integrados de Aula (PIA) y proyectos de Aula (PA)- Fundación universitaria Horizonte', 'FI210001', 'FI210001', 5, 2, 2, 4, 7, 1, 1, 600000, 'Este es un proyecto que sirve para gestionar el evento que se realiza anualmente el presupuesto solicitado es para los gastos del evento y  mejorar la calidad del mismo', '2019-05-16', '0000-00-00', '', 60000, 1, 0, 'edit', 'admin', '2019-12-06 09:12:06'),
(3, 'Promoviendo la escritura de artículos científicos desde los proyectos integrados de Aula (PIA)', 'FI210002', 'FI210002', 5, 2, 2, 4, 7, 1, 3, 1250000, 'Propuesta de prueba para el proyecto actual.', '2017-02-01', '0000-00-00', '', 0, 1, 0, 'edit', 'admin', '2019-12-06 09:12:51'),
(4, 'La teoría general de los sistemas en la gestión del riesgo', 'FI210003', 'FI210003', 5, 2, 1, 4, 7, 1, 3, 0, 'La teoría general de los sistemas en la gestión del riesgo', '2017-02-01', '0000-00-00', '', 0, 1, 0, 'edit', 'admin', '2019-12-06 09:12:08'),
(5, 'Practicidad y realidad social como instrumento de pedagogía en el desarrollo de proyectos empresariales', 'FI210004', 'FI210004', 5, 2, 2, 4, 7, 1, 3, 0, 'Practicidad y realidad social como instrumento de pedagogía en el desarrollo de proyectos empresariales', '2018-02-01', '0000-00-00', '16_archivo_informe_final.xls', 250000, 1, 0, 'edit', 'admin', '2019-12-06 09:12:12'),
(17, 'Efecto de los muros verdes sobre factores higiénicos', 'FI210005', 'FI210005', 5, 2, 3, 4, 7, 1, 3, 600000, 'Instalación del muro y mediciones higienicas', '2018-03-01', '0000-00-00', '', 0, 1, 0, 'add', 'admin', '2019-12-06 09:12:06');
...
(1, 'Proyectos UH', 'P-UH', 'uh', 5, 1, 'trademarks@olartemoure.com', 0, 'add', 'No', '2019-02-28 17:08:46');
...
--
ALTER TABLE `om_avances`
  MODIFY `id_avance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `om_lineas_por_programa`
  MODIFY `id_lineas_por_programa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `om_locks`
--
ALTER TABLE `om_locks`
  MODIFY `id_lock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
