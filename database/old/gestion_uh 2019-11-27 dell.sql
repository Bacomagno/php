...
--
-- Host: localhost
-- Generation Time: Nov 28, 2019 at 05:21 AM
...
--
-- Table structure for table `om_avances`
--
...
--
-- Dumping data for table `om_avances`
--

INSERT INTO `om_avances` (`id_avance`, `nombre_avance`, `iproyecto`, `presupuesto_ejecutado`, `fecha_entrega`, `archivo_avance`, `borrado`, `log_accion`, `log_usuario`, `log_timestamp`) VALUES
(1, 'Avance 1', 1, 54.5, '2019-06-05', 'a1.docx', 0, 'add', 'No', '2019-06-04 15:47:57'),
(2, 'Avance 2', 1, 45.5, '2019-06-06', 'a2.pdf', 0, 'add', 'No', '2019-06-04 15:47:57'),
(3, 'Avance N', 1, 49, '2019-06-07', 'a3.xlsx', 0, 'add', 'No', '2019-06-04 15:47:57'),
(4, 'prueba 1', 2, 21223, '2019-06-10', 'a4.txt', 0, 'add', 'No', '2019-06-11 00:27:56'),
(5, 'Primera entrega según cronograma', 8, 10000, '2019-11-27', '5_archivo_avance.pdf', 0, 'edit', 'admin', '2019-11-27 15:11:35'),
(6, 'Avance X', 1, 100000, '2019-11-27', '6_archivo_avance.docx', 0, 'add', 'admin', '2019-11-27 14:11:32'),
(7, 'Avance Y', 1, 200000, '2019-11-28', '7_archivo_avance.docx', 0, 'add', 'admin', '2019-11-27 14:11:14');

-- --------------------------------------------------------

--
-- Table structure for table `om_captcha`
--
...
--
-- Dumping data for table `om_captcha`
--
...
--
-- Table structure for table `om_facultades_lista`
--
...
--
-- Dumping data for table `om_facultades_lista`
--
...
--
-- Table structure for table `om_grupos_colciencias_lista`
--
...
--
-- Dumping data for table `om_grupos_colciencias_lista`
--
...
--
-- Table structure for table `om_grupos_unihorizonte`
--
...
--
-- Dumping data for table `om_grupos_unihorizonte`
--
...
(4, 'Grupo Xn proyecto', 0, 'edit', 'admin', '2019-11-27 15:11:22'),
(5, 'Grupo de prueba 1', 0, 'add', 'admin', '2019-11-27 15:11:33');

-- --------------------------------------------------------

--
-- Table structure for table `om_holidays`
--
...
--
-- Dumping data for table `om_holidays`
--
...
--
-- Table structure for table `om_languages`
--
...
--
-- Dumping data for table `om_languages`
--
...
--
-- Table structure for table `om_lineas_facultad_lista`
--
...
--
-- Dumping data for table `om_lineas_facultad_lista`
--
...
--
-- Table structure for table `om_lineas_institucionales_lista`
--
...
--
-- Dumping data for table `om_lineas_institucionales_lista`
--
...
--
-- Table structure for table `om_lineas_por_programa`
--
...
--
-- Dumping data for table `om_lineas_por_programa`
--
...
--
-- Table structure for table `om_locks`
--
...
--
-- Dumping data for table `om_locks`
--

INSERT INTO `om_locks` (`id_lock`, `id_usuario`, `nombre_usuario`, `tabla`, `id_registro`, `timestamp`, `borrado`, `log_accion`, `log_usuario`, `log_timestamp`) VALUES
(88, 1, 'Administrador', 'proyectos', 8, '2019-11-28 04:20:12', 0, 'add', 'No', '2019-11-28 04:20:12');
...
--
-- Table structure for table `om_productos`
--
...
--
-- Dumping data for table `om_productos`
--

INSERT INTO `om_productos` (`id_producto`, `proyecto`, `producto_colciencias`, `borrado`, `log_accion`, `log_usuario`, `log_timestamp`) VALUES
(1, 1, 1, 0, 'add', 'No', '2019-06-04 15:49:02'),
(2, 1, 2, 0, 'add', 'No', '2019-06-04 15:49:02'),
(3, 2, 1, 0, 'add', 'No', '2019-06-11 00:31:10'),
(4, 1, 14, 0, 'add', 'admin', '2019-11-27 14:11:47');

-- --------------------------------------------------------

--
-- Table structure for table `om_productos_lista_colciencias`
--
...
--
-- Dumping data for table `om_productos_lista_colciencias`
--
...
--
-- Table structure for table `om_programa_academico_lista`
--
...
--
-- Dumping data for table `om_programa_academico_lista`
--
...
--
-- Table structure for table `om_project_status`
--
...
--
-- Dumping data for table `om_project_status`
--
...
--
-- Table structure for table `om_proyectos`
--
...
--
-- Dumping data for table `om_proyectos`
--
...
(1, 'Primer proyecto', 'PR435775r2019', 'AA001-2018', 2, 4, 1, 4, 7, 1, 3, 149, 'qqq', '2019-06-04', '2019-06-07', 'final.docx', 149, 0, 'add', 'No', '2019-06-04 15:45:32'),
(2, 'Segundo proyecto', 'R2019rrQQ', 'AA002-2019', 4, 4, 2, 4, 7, 1, 3, 111, 'qqq', '2019-06-10', '0000-00-00', 'asdfad', 22, 0, 'add', 'No', '2019-06-11 00:25:09'),
(3, 'Tercer proyecto (prueba)', 'qwe', 'qwe', 2, 1, 2, 4, 7, 1, 3, 321321, 'sdaqweacsdcasd', '2019-09-16', '0000-00-00', '', 0, 0, 'edit', 'admin', '2019-11-27 11:11:38'),
(7, 'Proyecto Cuarto (Prueba pruebinha.)', 'qwe321232', 'qwe', 2, 1, 2, 4, 7, 1, 3, 321321, 'sdaqweacsdcasd', '2019-09-16', '0000-00-00', '', 0, 0, 'edit', 'admin', '2019-11-27 14:11:53'),
(8, 'ewqwe312', 'qwe321232qzqz', 'qwe', 2, 1, 2, 4, 7, 1, 3, 321321, 'sdaqweacsdcasd', '2019-09-16', '0000-00-00', '8_archivo_informe_final.docx', 0, 0, 'edit', 'admin', '2019-11-27 14:11:26');

-- --------------------------------------------------------

--
-- Table structure for table `om_roles_lista`
--
...
--
-- Dumping data for table `om_roles_lista`
--
...
--
-- Table structure for table `om_status`
--
...
--
-- Dumping data for table `om_status`
--
...
--
-- Table structure for table `om_subject_area`
--
...
--
-- Dumping data for table `om_subject_area`
--
...
--
-- Table structure for table `om_system`
--
...
--
-- Dumping data for table `om_system`
--
...
(2, 'Proyectos UH', 'P-UH', 'uh', 0, 1, 'trademarks@olartemoure.com', 0, 'add', 'No', '2019-02-28 17:08:46');

-- --------------------------------------------------------

--
-- Table structure for table `om_tasks`
--
...
--
-- Dumping data for table `om_tasks`
--
...
--
-- Table structure for table `om_tom_tasks`
--
...
--
-- Dumping data for table `om_tom_tasks`
--
...
(1, 0, 'Administrador', 'direccion.tic@unihorizonte.edu.co', '90bec6a873797ae97355a367dab57d371b7cd7e9', 'admin', 1, 1, '2018-02-13 21:20:39', 2, 0, 'edit', 'admin', '2019-11-27 12:11:27');
...
--
-- Dumping data for table `om_user_group`
--
...
--
-- Table structure for table `om_user_type`
--
...
--
-- Dumping data for table `om_user_type`
--
...
--
-- Indexes for table `om_avances`
--
ALTER TABLE `om_avances`
  ADD PRIMARY KEY (`id_avance`),
  ADD KEY `proyecto` (`iproyecto`);

--
-- Indexes for table `om_captcha`
--
...
--
-- Indexes for table `om_facultades_lista`
--
...
--
-- Indexes for table `om_grupos_colciencias_lista`
--
...
--
-- Indexes for table `om_grupos_unihorizonte`
--
...
--
-- Indexes for table `om_holidays`
--
ALTER TABLE `om_holidays`
  ADD PRIMARY KEY (`holiday_id`);

--
-- Indexes for table `om_languages`
--
ALTER TABLE `om_languages`
  ADD PRIMARY KEY (`language_id`);

--
-- Indexes for table `om_lineas_facultad_lista`
--
...
--
-- Indexes for table `om_lineas_institucionales_lista`
--
ALTER TABLE `om_lineas_institucionales_lista`
  ADD PRIMARY KEY (`id_linea_institucional_lista`);

--
-- Indexes for table `om_lineas_por_programa`
--
...
--
-- Indexes for table `om_productos`
--
...
--
-- Indexes for table `om_productos_lista_colciencias`
--
...
--
-- Indexes for table `om_programa_academico_lista`
--
...
--
-- Indexes for table `om_project_status`
--
...
--
-- Indexes for table `om_proyectos`
--
...
--
-- Indexes for table `om_roles_lista`
--
...
--
-- Indexes for table `om_status`
--
ALTER TABLE `om_status`
  ADD PRIMARY KEY (`status_id`);

--
-- Indexes for table `om_subject_area`
--
ALTER TABLE `om_subject_area`
  ADD PRIMARY KEY (`subject_area_id`);

--
-- Indexes for table `om_system`
--
...
--
-- Indexes for table `om_tom_tasks`
--
...
--
-- Indexes for table `om_user_type`
--
...
--
-- AUTO_INCREMENT for table `om_user_type`
--
ALTER TABLE `om_user_type`
  MODIFY `user_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- Constraints for table `om_avances`
--
ALTER TABLE `om_avances`
  ADD CONSTRAINT `om_avances_ibfk_1` FOREIGN KEY (`iproyecto`) REFERENCES `om_proyectos` (`id_proyecto`) ON UPDATE CASCADE;

--
-- Constraints for table `om_lineas_facultad_lista`
--
ALTER TABLE `om_lineas_facultad_lista`
...
--
-- Constraints for table `om_lineas_por_programa`
--
ALTER TABLE `om_lineas_por_programa`
...
--
-- Constraints for table `om_programa_academico_lista`
--
ALTER TABLE `om_programa_academico_lista`
...
--
-- Constraints for table `om_proyectos`
--
ALTER TABLE `om_proyectos`
...
--
-- Constraints for table `om_tom_tasks`
--
ALTER TABLE `om_tom_tasks`
...
--
-- Constraints for table `om_users`
--
ALTER TABLE `om_users`
...
--
-- Constraints for table `om_user_type`
--
ALTER TABLE `om_user_type`
