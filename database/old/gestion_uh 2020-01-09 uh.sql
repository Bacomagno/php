...
--
-- Servidor: localhost
-- Tiempo de generación: 10-01-2020 a las 01:14:28
...
(2, 'Avance 1', 1, 999, '2019-11-29', '', 0, 'edit', 'admin', '2019-12-02 17:12:41'),
(3, 'Avance 2', 1, 888, '2019-11-29', '', 0, 'edit', 'admin', '2019-12-02 17:12:49'),
(4, 'Avance 3', 1, 777, '2019-11-29', '', 0, 'edit', 'admin', '2019-12-02 17:12:57'),
(5, 'Avance 1', 2, 10000, '2019-11-27', '', 0, 'add', 'admin', '2019-11-29 11:11:51'),
(6, 'Avance 2', 2, 20000, '2019-11-28', '', 0, 'copy', 'admin', '2019-11-29 11:11:03'),
(7, 'Avance 3', 2, 30000, '2019-11-29', '', 0, 'edit', 'admin', '2019-11-29 11:11:12');
...
--
-- Estructura de tabla para la tabla `om_estado_proyecto`
--

CREATE TABLE `om_estado_proyecto` (
...
--
-- Volcado de datos para la tabla `om_estado_proyecto`
--

INSERT INTO `om_estado_proyecto` (`id_estado`, `nombre_estado`, `borrado`, `log_accion`, `log_usuario`, `log_timestamp`) VALUES
(1, 'EN CURSO', 0, 'add', 'No', '2019-02-28 17:07:40'),
(2, 'ANTEPROYECTO', 0, 'add', 'No', '2019-02-28 17:07:40'),
(3, 'FINALIZADO', 0, 'add', 'No', '2019-02-28 17:07:40');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `om_estudiantes`
--

CREATE TABLE `om_estudiantes` (
...
--
-- Volcado de datos para la tabla `om_estudiantes`
--

INSERT INTO `om_estudiantes` (`id_estudiante`, `nombres_estudiante`, `apellidos_estudiante`, `documento_estudiante`, `borrado`, `log_accion`, `log_usuario`, `log_timestamp`) VALUES
(1, 'BRANDON	JAIR', 'SEQUERA	PEREZ', '1010218663', 0, 'add', 'admin', '2020-01-09 12:01:44'),
(2, 'WENDY	VANESA', 'ALVARADO	RODRIGUEZ', '1003313623', 0, 'add', 'admin', '2020-01-09 12:01:00'),
(3, 'FABIOLA', 'UMAÑA	DIAZ', '1013653806', 0, 'add', 'admin', '2020-01-09 12:01:37'),
(4, 'NASLY	YORMARY', 'MORENO	PALACIOS', '1077092451', 0, 'add', 'admin', '2020-01-09 12:01:04');
...
(0, 'NO', 'NO', 0, 'add', 'No', '2019-12-09 17:45:10'),
...
(6, 'Proyectos Interfacultades', 'IF', 0, 'edit', 'admin', '2019-12-02 16:12:47'),
...
(0, 'NO', 0, 0, 'add', 'No', '2019-12-09 17:47:01'),
...
(0, 'NO', 0, 0, 'add', 'admin', '2019-12-02 17:12:17'),
(1, 'Riesgos	en	Seguridad Industrial', 1, 0, 'add', 'No', '2019-08-02 00:04:03'),
(2, 'Riesgos Higiénicos', 1, 0, 'add', 'No', '2019-08-02 00:04:03'),
(3, 'Administración de Salud y Seguridad en el Trabajo', 1, 0, 'edit', 'admin', '2019-12-02 17:12:22');
...
(1, 1, 14, 0, 'add', 'admin', '2019-11-29 16:11:53'),
(2, 2, 38, 0, 'edit', 'admin', '2019-12-06 14:12:18'),
(4, 1, 2, 0, 'add', 'admin', '2019-12-03 16:12:11'),
(5, 2, 45, 0, 'add', 'admin', '2019-12-06 14:12:43'),
(6, 4, 3, 0, 'add', 'admin', '2019-12-06 14:12:47'),
(7, 5, 1, 0, 'add', 'admin', '2019-12-06 14:12:53');
...
(0, 'NO', 'NO', 0, 0, 'add', 'No', '2019-12-09 17:48:11'),
(1, 'Ingeniería Seguridad Industrial e Higiene Ocupacional', '21', 7, 0, 'edit', 'admin', '2019-12-02 17:12:54'),
...
(5, 'Prueba 1', 'JG', 2, 0, 'add', 'admin', '2019-12-02 17:12:46');
...
INSERT INTO `om_proyectos` (`id_proyecto`, `nombre_proyecto`, `codigo_institucional_proyecto`, `acto_administrativo`, `grupo_unihorizonte`, `grupo_colciencias`, `linea_investigacion_institucional`, `docente_lider`, `facultad`, `linea_facultad`, `programa_academico`, `linea_programa`, `presupuesto_asignado`, `propuesta_proyecto`, `fecha_inicio`, `fecha_final`, `archivo_informe_final`, `presupuesto_ejecutado`, `estado`, `borrado`, `log_accion`, `log_usuario`, `log_timestamp`) VALUES
(1, 'SISTEMA WEB PARA LA GESTIÓN DE PROYECTOS DE INVESTIGACIÓN APLICADA Y FORMATIVA - UNIHORIZONTE.', 'FI210035', 'FI210035', 4, 4, 1, 1, 4, 7, 1, 3, 9999, 'Se trata de un sistema web para gestionar los productos generados por concepto de investigación aplicada o investigación formativa de los docentes, investigadores, estudiantes, auxiliares de investigación, semilleristas, funcionarios administrativos o usuarios externos de la universidad UniHorizonte, procurando mantener los indicadores y ponderaciones de manera que sean compatibles con los criterios de medición estipulados por Colciencias.', '2019-11-29', '0000-00-00', '1_archivo_informe_final.txt', 2664, 1, 0, 'edit', 'admin', '2019-12-02 17:12:17'),
(2, 'Encuentros de Proyectos Integrados de Aula (PIA) y proyectos de Aula (PA)- Fundación universitaria Horizonte', 'FI210001', 'FI210001', 5, 2, 2, 1, 4, 7, 1, 1, 600000, 'Este es un proyecto que sirve para gestionar el evento que se realiza anualmente el presupuesto solicitado es para los gastos del evento y  mejorar la calidad del mismo', '2019-05-16', '0000-00-00', '', 60000, 1, 0, 'edit', 'admin', '2019-12-06 09:12:06'),
(3, 'Promoviendo la escritura de artículos científicos desde los proyectos integrados de Aula (PIA)', 'FI210002', 'FI210002', 5, 2, 2, 1, 4, 7, 1, 3, 1250000, 'Propuesta de prueba para el proyecto actual.', '2017-02-01', '0000-00-00', '', 0, 1, 0, 'edit', 'admin', '2019-12-06 09:12:51'),
(4, 'La teoría general de los sistemas en la gestión del riesgo', 'FI210003', 'FI210003', 5, 2, 1, 1, 4, 7, 1, 3, 0, 'La teoría general de los sistemas en la gestión del riesgo', '2017-02-01', '0000-00-00', '', 0, 1, 0, 'edit', 'admin', '2019-12-06 09:12:08'),
(5, 'Practicidad y realidad social como instrumento de pedagogía en el desarrollo de proyectos empresariales', 'FI210004', 'FI210004', 5, 2, 2, 1, 4, 7, 1, 3, 0, 'Practicidad y realidad social como instrumento de pedagogía en el desarrollo de proyectos empresariales', '2018-02-01', '0000-00-00', '16_archivo_informe_final.xls', 250000, 1, 0, 'edit', 'admin', '2019-12-06 09:12:12'),
(17, 'Efecto de los muros verdes sobre factores higiénicos', 'FI210005', 'FI210005', 5, 2, 3, 1, 4, 7, 1, 3, 600000, 'Instalación del muro y mediciones higienicas', '2018-03-01', '0000-00-00', '', 0, 1, 0, 'add', 'admin', '2019-12-06 09:12:06');
...
(1, 'Proyectos UH', 'P-UH', 'uh', 16, 1, 'trademarks@olartemoure.com', 0, 'add', 'No', '2019-02-28 17:08:46');
...
(2, 0, 'Camilo Torres', 'camilo.torres@unihorizonte.edu.co', '90bec6a873797ae97355a367dab57d371b7cd7e9', 'camilotorres', 3, 2, '2018-02-13 21:20:39', 1, 0, 'edit', 'admin', '2020-01-09 15:01:53');
...
--
-- Indices de la tabla `om_estado_proyecto`
--
ALTER TABLE `om_estado_proyecto`
  ADD PRIMARY KEY (`id_estado`);

--
-- Indices de la tabla `om_estudiantes`
--
ALTER TABLE `om_estudiantes`
...
ALTER TABLE `om_proyectos`
  ...
  ADD KEY `docente_lider` (`docente_lider`);
...
--
-- AUTO_INCREMENT de la tabla `om_estado_proyecto`
--
ALTER TABLE `om_estado_proyecto`
  MODIFY `id_estado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `om_estudiantes`
--
ALTER TABLE `om_estudiantes`
...
--
ALTER TABLE `om_locks`
  MODIFY `id_lock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `om_programa_academico_lista`
  MODIFY `id_programa_academico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `om_proyectos`
  ...
  ADD CONSTRAINT `om_proyectos_ibfk_10` FOREIGN KEY (`docente_lider`) REFERENCES `om_users` (`user_id`) ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `om_proyectos_ibfk_9` FOREIGN KEY (`estado`) REFERENCES `om_estado_proyecto` (`id_estado`) ON UPDATE CASCADE;
