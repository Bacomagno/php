...
### Actualizar version BD

comando: ./mysql -u root -p -v --init-command="SET SESSION FOREIGN_KEY_CHECKS=0;" base_de_datos < /opt/lampp/htdocs/proyectos/database/base_de_datos\ 2019-05-15.sql