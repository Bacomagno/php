...
var orderedColumns = [
    {name: 'id_proyecto_programa_lista', breakpoints: '', visible: false, filterable: false, type: 'number'},
    {name: 'id_programas_lista', breakpoints: '', visible: true, filterable: true, sorted: true, direction: 'ASC', required:true},
