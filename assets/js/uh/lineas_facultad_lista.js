/*
 * HANDLING LINEAS POR FACULTAD
 */

var orderedColumns = [
    {name: 'id_linea_facultad_lista', breakpoints: '', visible: false, filterable: false, type: 'number'},
    {name: 'nombre_linea_facultad_lista', breakpoints: '', visible: true, filterable: true, sorted: true, direction: 'ASC', required:true},
    {name: 'facultad', breakpoints: '', visible: true, filterable: false, required:true},
];
