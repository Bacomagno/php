/*
 * HANDLING GRUPOS UNIHORIZONTE
 */

var orderedColumns = [
    {name: 'id_grupo', breakpoints: '', visible: false, filterable: false, type: 'number'},
    {name: 'proyecto', breakpoints: 'all', visible: false, filterable: true, required:true},
    {name: 'estudiante', breakpoints: '', visible: true, filterable: true, sorted: true, direction: 'ASC', required:true},
];
