...
var orderedColumns = [
    {name: 'facultad_lista_id', breakpoints: '', visible: false, filterable: false, type: 'number'},
    {name: 'name_facultad_lista', breakpoints: '', visible: true, filterable: true, sorted: true, direction: 'ASC', required:true},
