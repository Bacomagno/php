...
var orderedColumns = [
    {name: 'id_proyecto_linea_programa_lista', breakpoints: '', visible: false, filterable: false, type: 'number'},
    {name: 'id_lineas_programas_lista', breakpoints: '', visible: true, filterable: true, sorted: true, direction: 'ASC', required:true},
